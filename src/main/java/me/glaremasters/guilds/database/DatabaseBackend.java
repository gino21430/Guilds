...
public enum DatabaseBackend {
  ...
  DatabaseBackend(String backendName, Class<? extends GuildProvider> guildProvider,
      Class<? extends ChallengeProvider> challengeProvider,
      Class<? extends ArenaProvider> arenaProvider,
      Class<? extends CooldownProvider> cooldownProvider) {
  ...
  public static DatabaseBackend getByBackendName(String backendName) {
    return Arrays.stream(values()).filter(n -> n.backendName.equals(backendName.toLowerCase()))
