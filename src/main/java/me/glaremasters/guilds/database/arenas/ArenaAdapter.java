...
public class ArenaAdapter {
  ...
  public void createArena(@NotNull Arena arena) throws IOException {
    provider.createArena(sqlTablePrefix, arena.getId().toString(),
        Guilds.getGson().toJson(arena, Arena.class));
  }

  public void updateArena(@NotNull Arena arena) throws IOException {
    provider.updateArena(sqlTablePrefix, arena.getId().toString(),
        Guilds.getGson().toJson(arena, Arena.class));
  }
