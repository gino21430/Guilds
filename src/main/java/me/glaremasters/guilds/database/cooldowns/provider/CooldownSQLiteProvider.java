...
public interface CooldownSQLiteProvider extends CooldownProvider {
  ...
  boolean cooldownExists(@Define("prefix") @NotNull String tablePrefix,
      @NotNull @Bind("type") String cooldownType, @NotNull @Bind("owner") String cooldownOwner)
      throws IOException;
  ...
  void createCooldown(@Define("prefix") @NotNull String prefix, @NotNull @Bind("id") String id,
      @NotNull @Bind("type") String type, @NotNull @Bind("owner") String owner,
      @NotNull @Bind("expiry") Timestamp expiry);

  @Override
  @SqlUpdate("DELETE FROM <prefix>cooldowns WHERE type = :type AND owner = :owner")
  void deleteCooldown(@Define("prefix") @NotNull String prefix, @NotNull @Bind("type") String type,
      @NotNull @Bind("owner") String owner) throws IOException;
}