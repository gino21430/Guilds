...
/**
 * Created by GlareMasters Date: 3/19/2019 Time: 11:49 PM
 */
public class Serialization {
  ...
  public static Inventory deserializeInventory(String jsons, SettingsManager settingsManager)
   ...
   * @throws InvalidConfigurationException
   */
  public static Inventory deserializeInventory(String jsons, String title,
      SettingsManager settingsManager) throws InvalidConfigurationException {
    try {
      JsonConfiguration json = new JsonConfiguration();
