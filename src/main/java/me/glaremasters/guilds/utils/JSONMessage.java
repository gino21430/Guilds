...
public class JSONMessage {
  ...
  private static class ReflectionHelper {
    ...
    /**
     * Returns a class with the given package and name. This method replaces <code>{nms}</code>
     * with
     * <code>net.minecraft.server.[version]</code> and <code>{obc}</code> with
     * <code>org.bukkit.craft.[version]</code>
     * <br>
     * <br>
     * Example:
     *
