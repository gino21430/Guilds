...
public final class StringUtils {
  ...
  public static String getAnnouncements(JavaPlugin plugin) throws IOException {
    String announcement;
    URL url = new URL(
        "https://glaremasters.me/api/guilds/?id=" + plugin.getDescription().getVersion());
   ...
   * @return a new converted string Side note: No clue who made this This might be prone for removal
   * or be changed to a library / different function.
   */
